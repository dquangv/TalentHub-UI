...
import { Check, Star, Sparkles, Rocket, Zap } from 'lucide-react';
            ...
            <Card className="p-8 hover:shadow-lg transition-shadow">
              <div className="text-center mb-6">
                ...
                <div className="text-3xl font-bold mb-2">
                  Miễn phí
                  <span className="text-base font-normal text-muted-foreground"> / 7 ngày</span>
                </div>
                <p className="text-muted-foreground">Trải nghiệm các tính năng ưu tiên</p>
              </div>
          ...
          <FadeInWhenVisible delay={0.3}>
            <Card className="p-8 border-primary shadow-lg relative">
              ...
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold mb-2">1 Tháng</h3>
                <div className="text-3xl font-bold mb-2">
                  299.000đ
                  <span className="text-base font-normal text-muted-foreground"> / tháng</span>
                </div>
                <p className="text-muted-foreground">Tối ưu cho nhu cầu ngắn hạn</p>
              </div>
              <div className="space-y-4 mb-8">
          ...
          <FadeInWhenVisible delay={0.4}>
            <Card className="p-8 hover:shadow-lg transition-shadow">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold mb-2">6 Tháng</h3>
                <div className="text-3xl font-bold mb-2">
                  249.000đ
                  <span className="text-base font-normal text-muted-foreground"> / tháng</span>
                </div>
                <Badge variant="secondary" className="mb-2">Tiết kiệm 20%</Badge>
                <p className="text-muted-foreground">Tối ưu cho nhu cầu dài hạn</p>
              </div>
              <div className="space-y-4 mb-8">
