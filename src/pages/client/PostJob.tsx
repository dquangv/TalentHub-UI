                                                ...
                                                <CommandList>
                                                    ...
                                                    <CommandGroup>
                                                        {categories.map((category) => (
                                                            ...
                                                            >
                                                                <Check
                                                                    className={`mr-2 h-4 w-4 ${jobData.categoryId === category.id ? "opacity-100" : "opacity-0"
                                                                        }`}
                                                                />
                                    ...
                                    <CommandList>
                                        ...
                                        <CommandGroup>
                                            {skills.map((skill) => (
                                                ...
                                                >
                                                    <Check
                                                        className={`mr-2 h-4 w-4 ${selectedSkills.includes(skill.id) ? "opacity-100" : "opacity-0"
                                                            }`}
                                                    />
                                                    {skill.skillName}
                                                </CommandItem>
