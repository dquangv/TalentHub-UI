...
const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage }) => {
  ...
  return (
    <div
      className={`border-t px-2 sm:px-4 py-2 sm:py-3 chat-input-container ${
        isMobileKeyboardOpen ? "keyboard-open" : ""
      }`}
    >
      <div className="flex items-end space-x-2">
        <Textarea
          ...
          className="min-h-10 h-full border-0 focus-visible:ring-0 resize-none px-2 py-1 text-sm sm:text-base"
          rows={1}
          style={{
            overflow: "auto",
